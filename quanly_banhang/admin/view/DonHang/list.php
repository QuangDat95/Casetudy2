...
<div class="content">
    <div class="breadLine">
        <ul class="breadcrumb">
            <li><a href="DonHang/list.php">Đơn hàng</a></li>
        </ul>
    </div>
    <div class="workplace">
        <div class="row-fluid">
        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <div class="block-fluid table-sorting">
                    <a href="<?php echo $url_controller; ?>&action=add" class="btn btn-add">Thêm đơn hàng</a>
                    <table cellpadding="0" cellspacing="0" width="100%" class="table" id="tSortable_2">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo $url_controller; ?>&action=edit&id=<?php echo $row->ID_don_hang ;?>" class="btn btn-primary">Sửa</a>
                                    <a href="<?php echo $url_controller; ?>&action=delete&id=<?php echo $row->ID_don_hang ;?>" class="btn btn-danger" >Xóa</a>
                                    <a href="<?php echo $url_controller; ?>&action=view&id=<?php echo $row->ID_don_hang ;?>" class="btn btn-info" >Xem</a>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                            <!-- END LOOP-->
