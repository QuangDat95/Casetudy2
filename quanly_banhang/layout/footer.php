				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-md-3 col-xs-6">
							<div class="footer">
								<h3 class="footer-title">Các hãng điện thoại</h3>
								<ul class="footer-links">
									<li><a href="category.php?name=Apple">Apple</a></li>
									<li><a href="category.php?name=Samsung">Samsung</a></li>
									<li><a href="category.php?name=Nokia">Nokia</a></li>
									<li><a href="category.php?name=Realme">Realme</a></li>
									<li><a href="category.php?name=Xiaomi">Xiaomi</a></li>
									<li><a href="category.php?name=Vsmart">Vsmart</a></li>
								</ul>
							</div>
						</div>
					</div>
